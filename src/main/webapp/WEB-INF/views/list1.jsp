...
<body>
	...
	<!-- 삭제 폼  -->
	<c:url value="/delete" var="deleteUrl"></c:url>
	...
	<div class="modal fade" id="updateModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="exampleModalLabel">추가</h1>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<c:url value="/list" var="listUrl" />
					<form action="${listUrl }" method="post" id="addForm">
						<input class="form-control" type="text" name="name" id="input1" />
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
						data-bs-dismiss="modal">닫기</button>
					<input type="submit" class="btn btn-primary" form="addForm" value="추가" />
				</div>
			</div>
		</div>
	</div>
